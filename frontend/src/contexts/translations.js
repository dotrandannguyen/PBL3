...
export const translations = {
    ...
    vi: {
        ...
        'account.subtitle': 'Quản lý thông tin cá nhân, bảo mật và cài đặt tài khoản.',
        ...
        'account.security.password.googleHint': 'Bạn đăng nhập bằng Google — không có mật khẩu.',
        'account.security.password.localHint': 'Thay đổi mật khẩu tài khoản của bạn.',
        ...
        'account.danger.subtitle': 'Các hành động dưới đây không thể hoàn tác. Hãy chắc chắn trước khi tiếp tục.',
        'account.danger.delete.title': 'Xóa tài khoản',
        'account.danger.delete.hint': 'Tất cả dữ liệu công việc, sự kiện, và cài đặt sẽ bị xóa vĩnh viễn.',
        ...
        'general.subtitle': 'Tuỳ chỉnh giao diện, định dạng và cách ứng dụng hoạt động.',
        ...
        'integrations.subtitle': 'Kết nối các dịch vụ ngoài để đồng bộ dữ liệu vào workspace.',
        ...
        'trash.confirmDeleteBulkMessage': '{{count}} task sẽ bị xoá vĩnh viễn và không thể khôi phục. Bạn có chắc không?',
        'trash.confirmEmptyTitle': 'Dọn sạch thùng rác',
        'trash.confirmEmptyMessage': 'Toàn bộ {{count}} task trong thùng rác sẽ bị xoá vĩnh viễn. Hành động này không thể hoàn tác.',
        'trash.cancel': 'Huỷ',
    ...
    ja: {
        ...
        'account.security.password.googleHint': 'Googleでログインしているため、パスワードはありません。',
        'account.security.password.localHint': 'アカウントのパスワードを変更します。',
        ...
        'account.danger.subtitle': '以下の操作は取り消せません。続行する前にご確認ください。',
        'account.danger.delete.title': 'アカウント削除',
        'account.danger.delete.hint': 'すべてのタスク、イベント、設定データが完全に削除されます。',
        ...
        'integrations.subtitle': '外部サービスを接続して、ワークスペースにデータを同期します。',
        ...
        'trash.confirmDeleteBulkMessage': '{{count}} 件のタスクが完全に削除され、復元できません。よろしいですか？',
        'trash.confirmEmptyTitle': 'ゴミ箱を空にする',
        'trash.confirmEmptyMessage': 'ゴミ箱内のすべての {{count}} 件のタスクが完全に削除されます。元に戻せません。',
        'trash.cancel': 'キャンセル',
    ...
    en: {
        ...
        'account.subtitle': 'Manage your personal information, security, and account settings.',
        ...
        'account.security.password.googleHint': 'You signed in with Google — no password is set.',
        ...
        'account.danger.subtitle': 'These actions cannot be undone. Please proceed with caution.',
        'account.danger.delete.title': 'Delete account',
        'account.danger.delete.hint': 'All your tasks, events, and settings will be permanently removed.',
        ...
        'integrations.subtitle': 'Connect external services to sync data across your workspace.',
        ...
        'trash.confirmDeleteBulkMessage': '{{count}} tasks will be permanently deleted and cannot be recovered. Are you sure?',
        'trash.confirmEmptyTitle': 'Empty trash',
        'trash.confirmEmptyMessage': 'All {{count}} tasks in the trash will be permanently deleted. This cannot be undone.',
        'trash.cancel': 'Cancel',

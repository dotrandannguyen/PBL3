...
const UserAvatar = ({ initial, className = "" }) => (
  <div className={`user-avatar ${className}`}>{initial}</div>
);
...
const InboxPanel = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <div
        className={`inbox-overlay ${isOpen ? "open" : ""}`}
        onClick={onClose}
      />
      <div className={`inbox-panel ${isOpen ? "open" : ""}`}>
        <header className="inbox-header">
          ...
          <div className="inbox-actions">
            <button className="inbox-action-btn" title="Filter">
              <Filter size={14} />
            </button>
            <button className="inbox-action-btn" title="Mark all read">
              <Check size={14} />
            </button>
            <button className="inbox-action-btn" title="More">
  ...
  return (
    <div className="user-menu-wrapper" ref={menuRef}>
      ...
      >
        ...
        <ChevronDown
          size={14}
          className={`dropdown-icon transition-transform duration-200 ${open ? "rotate-180" : ""}`}
        />
      </button>
      ...
      {open && (
        <div className="user-dropdown">
          <div className="user-dropdown-header">
            <UserAvatar initial={initial} className="dropdown-avatar" />

...
const RegisterForm = () => {
    ...
    const getPasswordStrength = (password) => {
        ...
        if (password.length < 8) return { level: 2, text: 'Weak', color: 'text-amber-500' };
    ...
    return (
        <>
            ...
            <form className="text-left" onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    ...
                    <div className="relative flex items-center">
                        <User className="absolute left-3.5 text-text-tertiary pointer-events-none" size={18} />
                        <input
                            id="name"
                            name="name"
                            type="text"
                ...
                <div className="mb-4">
                    ...
                    <div className="relative flex items-center">
                        <Mail className="absolute left-3.5 text-text-tertiary pointer-events-none" size={18} />
                        <input
                            id="email"
                            name="email"
                            type="email"
                ...
                <div className="mb-5">
                    ...
                    <div className="relative flex items-center">
                        <Lock className="absolute left-3.5 text-text-tertiary pointer-events-none" size={18} />
                        <input
                            id="password"
                            name="password"
                    ...
                    {formData.password && (
                        <div className="flex items-center gap-3 mt-2.5">
                            ...
                            <span className={`text-xs font-medium min-w-[70px] text-right ${strength.color}`}>
                                {strength.text}
                            </span>
                        </div>
                    )}
            ...
            <p className="mt-4 mb-0 text-xs text-text-tertiary text-center leading-relaxed">
                ...
                <a href="#" className="text-text-secondary underline decoration-border-subtle transition-all duration-200 hover:text-white hover:decoration-white hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.5)]">
                    Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="text-text-secondary underline decoration-border-subtle transition-all duration-200 hover:text-white hover:decoration-white hover:drop-shadow-[0_0_6px_rgba(255,255,255,0.5)]">
